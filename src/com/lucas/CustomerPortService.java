 ...
 * 
 */
@WebServiceClient(name = "CustomerPortService", targetNamespace = "http://lucas.com", wsdlLocation = "http://localhost:8080/ws/customers.wsdl")
    ...
    extends Service
{
    ...
    private final static QName CUSTOMERPORTSERVICE_QNAME = new QName("http://lucas.com", "CustomerPortService");
    ...
    public CustomerPort getCustomerPortSoap11() {
        return super.getPort(new QName("http://lucas.com", "CustomerPortSoap11"), CustomerPort.class);
    }
    ...
    public CustomerPort getCustomerPortSoap11(WebServiceFeature... features) {
        return super.getPort(new QName("http://lucas.com", "CustomerPortSoap11"), CustomerPort.class, features);
    }
